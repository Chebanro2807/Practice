class Sliderww {
    constructor(){
        ...
        this._root = document.querySelector('.slider_ww_wrap');
        this._slides = document.querySelectorAll('.ww_item');

        this._nextBtn = document.querySelector('.slider__control-right-ww');
        this._prevBtn = document.querySelector('.slider__control-left-ww');
        ...
        this._allLi = document.querySelectorAll('.slider_indicators_ww li');
    ...
    hideSlide(slideNumber){
        let previousLi = document.querySelector('.slider_indicators_ww li[data-slide="' + slideNumber + '"]');
        previousLi.classList.remove('active_ww');
        const slide = this._slides[slideNumber];
        slide.classList.add('ww_item_hide');
    }

    showSlide(slideNumber){
        const slide = this._slides[slideNumber];
        slide.classList.remove('ww_item_hide');
        let nextLi = document.querySelector('.slider_indicators_ww li[data-slide="' + slideNumber + '"]');
        nextLi.classList.add('active_ww');
    }
